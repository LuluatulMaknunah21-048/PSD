...
if selected=='Data':
    ...
    st.write('data yang digunakan di ambil dari website UCI REPOSITORY : https://archive.ics.uci.edu/dataset/73/mushroom .Dataset mushroom digunakan untuk menganalisis faktor-faktor yang membedakan jamur yang dapat dikonsumsi dengan yang beracun berdasarkan berbagai fitur karakteristik')
    # Deskripsi Dataset
    st.write("**Deskripsi Dataset:**")

    # Jumlah Sampel
    st.write("1. **Jumlah Sampel:** Dataset \"Mushroom\" terdiri dari 8124 baris data, yang mewakili informasi tentang berbagai jenis jamur.")

    # Missing Value
    st.write("2. **Missing Value:**")
    st.write("   - Fitur \"Stalk Root (Akar Batang)\" mengandung nilai yang hilang (missing value) yang ditandai dengan tanda \"?\".")
    st.write("   - Untuk menangani nilai yang hilang pada fitur ini, dilakukan pengisian dengan modus dari data yang memiliki label yang sama dengan label pada missing value tersebut.")
    st.write("   - Pendekatan ini dipilih karena dataset ini bersifat kategorikal.")

    # One-Hot Encoding
    st.write("3. **One-Hot Encoding:**")
    st.write("   - Fitur-fitur kategorikal, seperti \"Cap Shape,\" \"Cap Surface,\" dan lainnya, dapat diubah menggunakan one-hot encoding.")
    st.write("   - Hal ini mengonversi nilai kategorikal menjadi vektor biner dengan 0 dan 1, memfasilitasi pemrosesan data dalam model pembelajaran.")

    # Fitur-Fitur pada Dataset (22 fitur dan label)
    st.write("4. **Fitur-Fitur pada Dataset (22 fitur dan label):**")

    # 1. Label (Edible/Poisonous)
    st.write("   1. **Label (Edible/Poisonous):**")
    st.write("      - **Deskripsi:** Menandakan apakah jamur tersebut dapat dikonsumsi (edible) atau beracun (poisonous).")
    st.write("      - **Kode:**")
    st.write("         - `edible=e`: Jamur dapat dikonsumsi.")
    st.write("         - `poisonous=p`: Jamur beracun.")

    # 2. Cap Shape (Bentuk Tudung)
    st.write("   2. **Cap Shape (Bentuk Tudung):**")
    st.write("      - **Deskripsi:** Menunjukkan bentuk fisik dari tudung jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menjelaskan tekstur permukaan tudung jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menandakan warna dari tudung jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menandakan apakah jamur tersebut akan memar saat disentuh atau tidak.")
    st.write("      - **Kode:**")
    ...
    # 6. Odor (Bau)
    st.write("   6. **Odor (Bau):**")
    st.write("      - **Deskripsi:** Menunjukkan aroma yang dihasilkan oleh jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menunjukkan bagaimana hubungan gill dengan batang jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menunjukkan seberapa rapat gill jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menunjukkan ukuran gill jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menunjukkan warna dari gill jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menunjukkan apakah batang jamur membesar atau menyempit.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menjelaskan jenis akar batang jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menunjukkan tekstur permukaan batang di atas cincin jamur.")
    st.write("      - **Kode:**")
    st.write("         - `fibrous=f`: Permukaan serat.")
    st.write("         - `scaly=y`: Permukaan bersisik.")
    ...
    st.write("      - **Deskripsi:** Menunjukkan tekstur permukaan batang di bawah cincin jamur.")
    st.write("      - **Kode:**")
    st.write("         - `fibrous=f`: Permukaan serat.")
    st.write("         - `scaly=y`: Permukaan bersisik.")
    st.write("         - `silky=k`: Permukaan berkilau.")
    ...
    st.write("      - **Deskripsi:** Menunjukkan warna batang di atas cincin jamur.")
    st.write("      - **Kode:**")
    st.write("         - `brown=n`: Coklat.")
    st.write("         - `buff=b`: Coklat muda.")
    st.write("         - `cinnamon=c`: Coklat kayu manis.")
    ...
    st.write("      - **Deskripsi:** Menunjukkan warna batang di bawah cincin jamur.")
    st.write("      - **Kode:**")
    st.write("         - `brown=n`: Coklat.")
    st.write("         - `buff=b`: Coklat muda.")
    st.write("         - `cinnamon=c`: Coklat kayu manis.")
    ...
    st.write("      - **Deskripsi:** Menunjukkan tipe tutup (veil) jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menunjukkan warna tutup jamur.")
    st.write("      - **Kode:**")
    st.write("         - `brown=n`: Coklat.")
    st.write("         - `orange=o`: Oranye.")
    st.write("         - `white=w`: Putih.")
    ...
    st.write("      - **Deskripsi:** Menunjukkan jumlah cincin pada jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menunjukkan jenis cincin pada jamur.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menunjukkan warna spora yang dihasilkan oleh jamur.")
    st.write("      - **Kode:**")
    st.write("         - `black=k`: Hitam.")
    st.write("         - `brown=n`: Coklat.")
    st.write("         - `buff=b`: Coklat muda.")
    ...
    st.write("      - **Deskripsi:** Menunjukkan sebaran populasi jamur di suatu tempat.")
    st.write("      - **Kode:**")
    ...
    st.write("      - **Deskripsi:** Menunjukkan habitat tempat tumbuhnya jamur.")
    st.write("      - **Kode:**")
